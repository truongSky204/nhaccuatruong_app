...
class _NowPlayingPageState extends State<NowPlayingPage>
  ...
  void _setNextSong() {
    if (_isShuffle) {
      ...
      ++_selectedItemIndex; // ✅ Không cần `{}` riêng cho 1 câu lệnh đơn
    } else if (_loopMode == LoopMode.all &&
        _selectedItemIndex == widget.songs.length - 1) {
      _selectedItemIndex =
          0; // ✅ Nếu đang ở bài cuối và chế độ lặp danh sách bật, quay lại bài đầu
    }
  ...
  void _setPrevSong() {
    if (_isShuffle) {
      ...
      --_selectedItemIndex; // ✅ Lệnh giảm index không cần `{}` riêng
    } else if (_loopMode == LoopMode.all && _selectedItemIndex == 0) {
      _selectedItemIndex =
          widget.songs.length - 1; // ✅ Lặp lại từ cuối danh sách
    }
